...
vim.keymap.set('i', '<M-l>', '◊', { desc = 'Lozenge' })
vim.keymap.set('i', '<M-p>', '⚘', { desc = 'Floret' })
vim.keymap.set('i', '<M-j>', '«', { desc = 'Sunflower open quote' })
vim.keymap.set('i', '<M-k>', '»', { desc = 'Sunflower close quote' })

...
(provide reflow_textobject_around)
(define (reflow_textobject_around)
    (helix.static.reflow_textobject_around *helix.cx*))

(provide reflow_textobject_inner)
(define (reflow_textobject_inner)
    (helix.static.reflow_textobject_inner *helix.cx*))
...
(provide expand_macro)
(define (expand_macro)
    (helix.static.expand_macro *helix.cx*))

...
install_mise() {
	...
	if exists apk; then
		...
		env MISE_DISABLE_TOOLS='node,python,aqua:pnpm/pnpm,npm:perlnavigator-server,npm:bash-language-server,npm:typescript-language-server,npm:oxlint,npm:vscode-langservers-extracted,aqua:Wilfred/difftastic,github:rustsec/rustsec' \

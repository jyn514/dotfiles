...
The adapter belongs under `tools/agent-podman`, rather than the general agent-wrapper layer, because remote path staging and daemon placement are properties of the Podman-machine integration.

...
conventional dictionary and rule outlines cover 94.1539% after Zipf weighting
at a 40,959-byte total. This is an in-sample optimization metric: the
...
and RFC 9110 measured 87.45% conventional token coverage after apostrophe
normalization, ranging from 82.67% to 91.30% by corpus. The same frozen model
scores 99.39%, 97.25%, 94.15%, and 91.74% when the frequency-list denominator is
